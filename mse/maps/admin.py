...
class GeomapAdmin(admin.ModelAdmin):
    fieldsets = [
        (None,            {'fields': ['title', 'short_name', 'map_type', 'init_lat', 'init_long', 'init_zoom', 'fusion_table_id', 'date_range', 'description', 'caption', 'credit', 'log_link_type', 'sites']}),
    ...
    filter_horizontal = ['resourcesets', 'artifacts', 'documents', 'connections', 'weblinks', 'biblio', 'essays', 'audiovisuals', 'lectures', 'maps', 'profiles', 'sites']
